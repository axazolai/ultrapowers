...
Report path: <project>/.claude/.scratchpad/diagnosing/<session-id>/report.md
...
what would raise it. No statement about what ultrapowers should do.>
...
- Harness and version:
- Models seen:
- Ultrapowers install root / version / git sha:
...
## 7. Ultrapowers involvement (REQUIRED)
